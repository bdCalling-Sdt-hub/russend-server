...
const countryData = [
  {
    ...
    currency: "XAF",
    countryFlag:
      process.env.IMAGE_UPLOAD_BACKEND_DOMAIN + "/uploads/flags/cameroon.svg",
    paymentGateways: [
      {
        name: "Orange Money",
        logo:
          process.env.IMAGE_UPLOAD_BACKEND_DOMAIN +
          "/uploads/gateways/orange_money.png",
      },
      {
        name: "MTN Mobile Money",
        logo:
          process.env.IMAGE_UPLOAD_BACKEND_DOMAIN + "/uploads/gateways/mtn.png",
      },
    ],
  ...
  },
  {
    ...
    currency: "XAF",
    countryFlag:
      process.env.IMAGE_UPLOAD_BACKEND_DOMAIN + "/uploads/flags/gabon.svg",
    paymentGateways: [
      {
        name: "Mobile Money CEMAC",
        logo:
          process.env.IMAGE_UPLOAD_BACKEND_DOMAIN +
          "/uploads/gateways/cemac.png",
      },
    ],
    isPaymentAvailable: true,
  },
  {
    ...
    countryFlag:
      process.env.IMAGE_UPLOAD_BACKEND_DOMAIN +
      "/uploads/flags/equatorial_guinea.svg",
    paymentGateways: [
      {
        name: "Mobile Money CEMAC",
        logo:
  ...
  },
  {
    ...
    currency: "XAF",
    countryFlag:
      process.env.IMAGE_UPLOAD_BACKEND_DOMAIN + "/uploads/flags/congo.svg",
    paymentGateways: [
      {
        name: "Mobile Money CEMAC",
        logo:
  ...
  },
  {
    ...
    currency: "XAF",
    countryFlag:
      process.env.IMAGE_UPLOAD_BACKEND_DOMAIN + "/uploads/flags/chad.svg",
    paymentGateways: [
      {
        name: "Mobile Money CEMAC",
        logo:
  ...
  },
  {
    ...
    countryFlag:
      process.env.IMAGE_UPLOAD_BACKEND_DOMAIN +
      "/uploads/flags/central_african.svg",
    paymentGateways: [
      {
        name: "Mobile Money CEMAC",
        logo:
  ...
  },
  {
    ...
    currency: "KZT",
    countryFlag:
      process.env.IMAGE_UPLOAD_BACKEND_DOMAIN + "/uploads/flags/kazakhstan.svg",
  ...
  },
  {
    ...
    currency: "TJS",
    countryFlag:
      process.env.IMAGE_UPLOAD_BACKEND_DOMAIN + "/uploads/flags/Tajikistan.svg",
    isPaymentAvailable: false,
  },
  {
    name: "Belarus",
    ...
    currency: "BYN",
    countryFlag:
      process.env.IMAGE_UPLOAD_BACKEND_DOMAIN + "/uploads/flags/belarus.svg",
    isPaymentAvailable: false,
  },
];
